...
export default function ContactSection() {
    ...
    return (
        <section id='contact' className='bg-Blue-600 h-90 px-8 flex flex-col gap-8 justify-center items-center text-center md:px-40'>
            ...
            <form noValidate
                ...
                className='flex flex-col gap-4 md:flex-row w-full max-w-110'
            >
                <div className={`w-full md:grow ${error ? "bg-Red-400 rounded-b-[5px]" : ""}`}>
                    ...
                    <div id={errorId} role='alert' aria-live='polite' className='text-white text-[10px] italic px-4 pt-1 pb-1.5 text-left'>
                        {error}
                    </div>
                </div>
                <button
